...
const Testimoni = () => {
  return (
    <div className="container flex flex-col justify-center items-center md:mt-20 mt-5 w-full h-full mx-auto">
      {/* Judul */}
      ...
      <div className="flex flex-wrap md:flex-nowrap justify-center items-center gap-2 px-0 mt-8">
        {/* Kartu Testimoni */}
        <div className="relative md:w-[300px] md:h-[219px] w-[165px] h-[210px] flex flex-col items-center border-2 bg-macaronilight3 md:rounded-3xl rounded-xl md:px-[32px] md:pt-[56px] px-[8px] pt-[35px] pb-[24px] gap-[1px]">
          {/* Lingkaran Profil */}
          <div
          ...
          {/* Konten Testimoni */}
          <p className="text-left md:text-xs text-[10px] text-macaronidark md:pb-2 -mt-2">
        ...
        <div className="relative md:w-[300px] md:h-[219px] w-[165px] h-[210px] flex flex-col items-center border-2 bg-macaronilight3 md:rounded-3xl rounded-xl md:px-[32px] md:pt-[56px] px-[8px] pt-[35px] pb-[24px] gap-[1px]">
          ...
          ></div>
          {/* Konten Testimoni */}
          <p className="text-left md:text-xs text-[10px] text-macaronidark md:pb-[22px] -mt-2">
        ...
        <div className="relative md:w-[300px] md:h-[219px] w-[165px] h-[210px] md:mt-0 mt-8 flex flex-col items-center border-2 bg-macaronilight3 md:rounded-3xl rounded-xl md:px-[32px] md:pt-[56px] px-[8px] pt-[35px] pb-[24px] gap-[1px]">
          {/* Lingkaran Profil */}
          <div
            className="absolute md:-top-10 md:left-8 -top-9 left-4 md:h-[80px] md:w-[80px] w-[60px] h-[60px] bg-macaronidark rounded-full bg-cover bg-center"
