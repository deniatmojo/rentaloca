...
const Navbar = () => {
  return (
    <nav
      className="container relative mx-auto max-w-6xl 2xl:w-screen h-20 px-4 z-20"
      aria-label="Global"
    >
      <div className="container absolute left-7 max-w-6xl 2xl:w-screen h-full flex items-center justify-between border-b-2">
        {/* Logo */}
