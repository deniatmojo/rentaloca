  ...
  return (
    <div>
      <div className="container h-auto w-full md:mt-[124px] mt-[64px] mx-auto items-center justify-center font-Inter md:px-2 px-4">
        ...
        {/* Kontainer Utama */}
        <div className="container flex flex-col sm:flex-row w-full h-auto mx-auto px-2 rounded-sm md:mt-[48px] mt-[32px] gap-4 md:gap-[10px]">
          {/* Box 1 */}
          <div
            className="w-full sm:w-[413px] h-[241px] bg-cover bg-center rounded-lg overflow-hidden relative shadow-md"
          ...
          {/* Box 2 */}
          <div
            className="w-full sm:w-[413px] h-[241px] bg-cover rounded-lg relative overflow-hidden shadow-md"
