const footer = () => {
  return (
    <div>
      <div
        className="container flex items-center justify-center max-w-7xl h-[360px]"
        style={{ backgroundImage: "url('/img/bgfooter.png')" }}
      >
        <div className="container flex flex-1 w-[1280px] h[216px] gap-[40px]">
          <div className="container flex flex-col w-[413px] h-[216px] relative">
            <a
