          ...
          <div className="relative flex flex-col lg:flex-row lg:justify-between gap-x-24 gap-y-10">
            <div className="flex flex-col relative">
              ...
              <p className="text-sm text-macaronidark leading-relaxed max-w-2xl text-pretty">
                Rentaloca Indonesia is an innovative platform revolutionizing fashion accessibility. We provide an easy clothing rental solution, allowing users to explore thousands of trendy outfit options without the need to purchase.
              </p>
            ...
            <div className="flex flex-col lg:flex-row flex-wrap gap-y-4 lg:justify-between w-full">
              <div className="">
                <h1 className="text-macaronidark text-sm font-Inter font-bold whitespace-nowrap">
                  PRODUCT & SERVICE
                </h1>
              ...
              <div className="">
                <h2 className="text-macaronidark text-sm font-Inter font-bold">
                  COMPANY
                </h2>
                <h1 className="text-macaronidark text-xs font-Inter mt-2 mb-2">
                  Lorem Ipsum
